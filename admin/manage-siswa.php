...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) && $_GET['hal'] == "edit") {
        ...
        // menjalankan query
        $query = "INSERT INTO tblsiswa (nama, nis, username, password, walikelas, kelas) VALUES ('$tnama', '$tnis', '$tusername', '$tpassword', '$twali', '$tkelas')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><b>Data Siswa</h1>
                    <br>
                    <!-- Awal Card -->
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="mb-3 row">
                                    <label for="inputnama" class="col-sm-2 col-form-label">Wali Kelas</label>
                                    <div class="col-sm-5">
                                        <select name="twali" id="twali" class="form-select" required>
                                            <option value="<?= $vwali ?>"><?= $vwali ?></option>
                                            <?php
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-stripped table-hover table-bordered">
                                ...
                                if (isset($_POST['bcari'])) {
                                    ...
                                    $keyword = $_POST['tcari'];
                                    $q = "SELECT * FROM tblsiswa WHERE nama like '%$keyword%' or nis like '%$keyword%' or username like '%$keyword%' or password like '%$keyword%' order by id desc";
                                ...
                                while ($data = mysqli_fetch_array($tampil)):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="manage-siswa.php?hal=edit&id=<?= $data['id'] ?>"
                                                class="btn btn-warning">Edit</a>
                                            <a href="manage-siswa.php?hal=hapus&id=<?= $data['id'] ?>"
