...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) && $_GET['hal'] == "edit") {
        ...
        // menjalankan query
        $query = "INSERT INTO tblizin (nama, nis, kelas, tanggal, keterangan, alasan) VALUES ('$tnama', '$tnis', '$tkelas', '$ttanggal', '$tketerangan', '$talasan')";
...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
        integrity="sha512-rFvtvtIyBfjKvCmk8WgMXLWyYdxHkJQoV/ZZ0g+WW7/t0e5iA2mwRs5Lz8NtrpRPjct6fZU6A/mvaxRPTe4Siw=="
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.1.0/css/bootstrap.min.css"
        integrity="sha512-S0A9RJt0McFt+lGCPjuT1UYK0RTYkZrDf3cwhdmx1mnX9yAYE4f4WqLQo33n7DkZ51nHd8Wuknm6N5+sN04XjQ=="
        crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><b>Rekap Izin Siswa</h1>
                    <br>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-stripped table-hover table-bordered">
                                ...
                                if (isset($_POST['bcari'])) {
                                    ...
                                    $keyword = $_POST['tcari'];
                                    $q = "SELECT * FROM tblizin WHERE nama like '%$keyword%' or nis like '%$keyword%' or kelas like '%$keyword%' or tanggal like '%$keyword%' or keterangan like '%$keyword%' or status like '%$keyword%' order by id desc";

                                } else {
                                    $q = "SELECT * FROM tblizin order by id desc";
                                }
                                ...
                                while ($data = mysqli_fetch_array($tampil)):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $sql = "SELECT * FROM tblizin WHERE id={$data['id']}";
                                            $result = mysqli_query($koneksi, $sql);

                                            //looping untuk menampilkan data pengajuan izin
                                            while ($izin = mysqli_fetch_assoc($result)) {
                                                if ($izin['status'] === 'P') {
                                                    echo '<h5><span class="badge badge-warning">Pending <i class="fas fa-hourglass-half"></i></span></h5>';
                                                } elseif ($izin['status'] === 'N') {
                                                    echo '<h5><span class="badge badge-danger">Tolak <i class="fas fa-times"></i></span></h5>';
                                                } else {
                                                    echo '<h5><span class="badge badge-success">Terima <i class="fas fa-check"></i></span></h5>';
                                                }
                                            }
                                            ?>
                                        </td>
                                        <td>
                                            <a href="proses-izin.php?id=<?= $data['id'] ?>&s=N" class="btn btn-warning"
                                                onclick="return confirm('Tolak?')"><i class="fas fa-times"></i></a>
                                            <a href="proses-izin.php?id=<?= $data['id'] ?>&s=Y" class="btn btn-success"
                                                onclick="return confirm('Terima?')"><i class="fas fa-check"></i></a>
                                        </td>
                                    </tr>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.1.0/js/bootstrap.min.js"
        integrity="sha512-PwKMc1MkZFFYqo3rJtQJe9tzhHc0R1+g8sMYtTlT0FhcY/iY0qncr+BUjzEfhVUhvL8T+e50PzYb/rnJn1S+kw=="
