...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) && $_GET['hal'] == "edit") {
        //data akan diedit
        $update = mysqli_query($koneksi, "UPDATE tblkelas SET
                                            kelas     = '$_POST[tkelas]',
                                            jurusan  = '$_POST[tjurusan]',
                                            tajaran   = '$_POST[ttajaran]',
        ...
        $tkelas = $_POST['tkelas'];
        $tjurusan = $_POST['tjurusan'];
        $ttajaran = $_POST['ttajaran'];
        $tsemester = $_POST['tsemester'];


        // menjalankan query
        $query = "INSERT INTO tblkelas (kelas, jurusan, tajaran, semester) VALUES ('$tkelas', '$tjurusan', '$ttajaran', '$tsemester')";
    ...
    $hapus = mysqli_query($koneksi, "DELETE FROM tblkelas WHERE id ='$_GET[id]' ");
...
if (isset($_GET['hal'])) {
    ...
    if ($_GET['hal'] == "edit") {
        ...
        $tampil = mysqli_query($koneksi, "SELECT * FROM tblkelas WHERE id = '$_GET[id]'");
        $data = mysqli_fetch_array($tampil);
        if ($data) {
            //jika data ditemukan, maka data ditampung ke dalam variabel
            $vkelas = $data['kelas'];
            $vjurusan = $data['jurusan'];
            $vtajaran = $data['tajaran'];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><b>Data Kelas</h1>
                    <br>
                    <!-- Awal Card -->
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="tkelas" id="tkelas"
                                            value="<?= $vkelas ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    <label for="inputnama" class="col-sm-2 col-form-label">Tahun Ajaran</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="ttajaran" id="ttajaran"
                                            value="<?= $vtajaran ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-stripped table-hover table-bordered">
                                ...
                                if (isset($_POST['bcari'])) {
                                    ...
                                    $keyword = $_POST['tcari'];
                                    $q = "SELECT * FROM tblkelas WHERE kelas like '%$keyword%' or jurusan like '%$keyword%' or tajaran like '%$keyword%' or semester like '%$keyword%' order by id desc";

                                } else {
                                    $q = "SELECT * FROM tblkelas order by id desc";
                                }
                                ...
                                while ($data = mysqli_fetch_array($tampil)):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="manage-kelas.php?hal=edit&id=<?= $data['id'] ?>"
                                                class="btn btn-warning">Edit</a>
                                            <a href="manage-kelas.php?hal=hapus&id=<?= $data['id'] ?>"
