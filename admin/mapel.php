...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) && $_GET['hal'] == "edit") {
        //data akan diedit
        $update = mysqli_query($koneksi, "UPDATE tblmapel SET
                                            mapel    = '$_POST[tmapel]',
                                            guru     = '$_POST[tguru]'
                                        WHERE id = '$_GET[id]'
                                        ");
        ...
        // menjalankan query
        $query = "INSERT INTO tblmapel (mapel, guru) VALUES ('$tmapel', '$tguru')";
    ...
    $hapus = mysqli_query($koneksi, "DELETE FROM tblmapel WHERE id ='$_GET[id]' ");
...
if (isset($_GET['hal'])) {
    ...
    if ($_GET['hal'] == "edit") {
        ...
        $tampil = mysqli_query($koneksi, "SELECT * FROM tblmapel WHERE id = '$_GET[id]'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><b>Data Mata Pelajaran</h1>
                    <br>
                    <!-- Awal Card -->
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="tmapel" id="tmapel"
                                            value="<?= $vmapel ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                            ...
                            <div class="scroll">
                                <table class="table table-stripped table-hover table-bordered">
                                    ...
                                    if (isset($_POST['bcari'])) {
                                        ...
                                        $keyword = $_POST['tcari'];
                                        $q = "SELECT * FROM tblmapel WHERE mapel like '%$keyword%' or guru like '%$keyword%' order by id desc";

                                    } else {
                                        $q = "SELECT * FROM tblmapel order by id desc";
                                    }
                                    ...
                                    while ($data = mysqli_fetch_array($tampil)):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="mapel.php?hal=edit&id=<?= $data['id'] ?>"
                                                    class="btn btn-warning">Edit</a>
                                                <a href="mapel.php?hal=hapus&id=<?= $data['id'] ?>"
