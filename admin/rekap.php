...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) && $_GET['hal'] == "edit") {
        //data akan diedit
        $update = mysqli_query($koneksi, "UPDATE tblabsen SET
                                            nama_siswa    = '$_POST[tnama]',
                                            nis     = '$_POST[tnis]',
                                            kelas  = '$_POST[tkelas]',
                                            masuk   = '$_POST[tmasuk]',
                                            terlambat   = '$_POST[tterlambat]',
                                            tgl_absen   = '$_POST[ttgl_absen]'
        ...
        $tkelas = $_POST['tkelas'];
        $tmasuk = $_POST['tmasuk'];
        $tterlambat = $_POST['tterlambat'];
        $ttgl_absen = $_POST['ttgl_absen'];


        // menjalankan query
        $query = "INSERT INTO tblabsen (nama, nis, kelas, masuk, terlambat, tgl_absen) VALUES ('$tnama', '$tnis', '$tkelas', '$tmasuk', '$tterlambat', '$ttgl_absen')";
    ...
    $hapus = mysqli_query($koneksi, "DELETE FROM tblabsen WHERE id ='$_GET[id]' ");
...
if (isset($_GET['hal'])) {
    ...
    if ($_GET['hal'] == "edit") {
        ...
        $tampil = mysqli_query($koneksi, "SELECT * FROM tblabsen WHERE id = '$_GET[id]'");
        ...
        if ($data) {
            ...
            $vkelas = $data['kelas'];
            $vmasuk = $data['masuk'];
            $vterlambat = $data['terlambat'];
            $vtgl_absen = $data['tgl_absen'];
        }
    }
}
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><b>Rekap Presensi Siswa</h1>
                    <br>
                    <!-- Awal Card -->
                            ...
                            <div class="col-md-6 mx-auto">
                                <form method="POST">
                                    <div class="input-group mb-3">
                                        ...
                                        <button class="btn btn-primary" name="bcari" type="sumbit">Tampilkan</button>
                                        <button class="btn btn-danger" name="breset" type="submit">Reset</button>
                                        <a href="laporan.php" class="btn btn-info">Export Data</a>
                            ...
                            <table class="table table-stripped table-hover table-bordered">
                                ...
                                while ($data = mysqli_fetch_array($tampil)):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="rekap.php?hal=hapus&id=<?= $data['id'] ?>" class="btn btn-danger"
