...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) && $_GET['hal'] == "edit") {
        //data akan diedit
        $update = mysqli_query($koneksi, "UPDATE tbladmin SET
                                            nama     = '$_POST[tadmin]',
        ...
        $tpassword = password_hash($_POST['tpassword'], PASSWORD_DEFAULT); // hash password sebelum disimpan


        // menjalankan query
        $query = "INSERT INTO tbladmin (nama, username, password) VALUES ('$tadmin', '$tusername', '$tpassword')";
    ...
    $hapus = mysqli_query($koneksi, "DELETE FROM tbladmin WHERE id ='$_GET[id]' ");
...
if (isset($_GET['hal'])) {
    ...
    if ($_GET['hal'] == "edit") {
        ...
        $tampil = mysqli_query($koneksi, "SELECT * FROM tbladmin WHERE id = '$_GET[id]'");
...
<span class="mr-2 d-none d-lg-inline text-gray-600 small">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><b>Pengaturan Akun Akun Admin</h1>
                    <br>
                    <!-- Awal Card -->
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                <div class="mb-3 row">
                                    <label for="inputnama" class="col-sm-2 col-form-label">Nama Admin</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="tadmin" id="tadmin"
                                            value="<?= $vadmin ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-stripped table-hover table-bordered">
                                ...
                                if(isset($_POST['bcari'])){
                                    ...
                                    $keyword = $_POST['tcari'];
                                    $q = "SELECT * FROM tbladmin WHERE nama like '%$keyword%' order by id desc";

                                }else {
                                    $q = "SELECT * FROM tbladmin order by id desc";
                                }
                                ...
                                while ($data = mysqli_fetch_array($tampil)):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="setting.php?hal=edit&id=<?= $data['id'] ?>"
                                                class="btn btn-warning">Edit</a>
                                            <a href="setting.php?hal=hapus&id=<?= $data['id'] ?>"
                                                class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">Reset</a>
                                        </td>
